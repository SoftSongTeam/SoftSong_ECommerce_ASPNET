...
public class ClasseConexao
{
    ...
    private SqlConnection conectar()
    {
        try
        {
            String dataBase = "LojaMusica";
			String strConexao = "Password=16m0g$06; Persist Security Info=True; User ID=sa; Initial Catalog=" + dataBase + "; Data Source=" + Environment.MachineName;
			//String strConexao = "Password=etesp; Persist Security Info=True; User ID=sa; Initial Catalog=" + dataBase + "; Data Source=" + Environment.MachineName;
			//String strConexao = "Password=etesp; Persist Security Info=True; User ID=aluno; Initial Catalog=" + dataBase + "; Data Source=" + Environment.MachineName;
	...
	public DataTable InsereImagem(Byte[] buffer)
	{
		SqlCommand cmd = new SqlCommand();
		SqlDataAdapter da = new SqlDataAdapter();
		DataTable dt = new DataTable();
		...
		{
			conectar();
			cmd = new SqlCommand("insert into img(content) values (@image)"); //não digitar Exec, não passar os parâmetros
